...
var setBP = {
    ...
    onKeyUp: function (jsn) {
		if (parseInt(this.settings[jsn.context].bp)>5) {this.settings[jsn.context].bp = 5;} else if (parseInt(this.settings[jsn.context].bp)<0) {this.settings[jsn.context].bp = 0};
